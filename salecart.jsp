		...
		<c:choose>
			...
			<c:otherwise>
				<div id="carousel">
					...
					<form action="RedisPayPage.jsp" class="comeonmodal" id="forminfo">
						<table>
							<tbody>
							...
							${redisproduct}
									...
									<tr>
										...
										<td class="col1"><img
											src="./img_product/${redisproduct.product_img}"></td>
										<td class="col2">
											<div>
												<input type="hidden" name="cart_id" value="${redisproduct.cart_id }">
												<input id="id" type="hidden" name="product_img"
													type="hidden" value="./img_product/${redisproduct.product_img}">
												<input id="id" type="hidden" name="id" value="${my.id}">
												<input id="product_name" name="product_name" type="text"
													value="${redisproduct.product_name}"> <br> <input
													id="product_cod" name="product_cod" type="text"
													value="${redisproduct.product_cod}"> <br>
										...
										<td><input class=pluss type='button' value='+'>
											...
											<div id='result'>
												<input name="salequantity" value="${redisproduct.product_quantity}">
											</div> <input class=pluss type='button' value='-' /></td>
										<td class="onetoonprice">
										<input id="product_price" type="hidden" name="product_price" value="${redisproduct.product_price}">
										${redisproduct.product_price}										
										</td>
										
										<td class="quantityprice">${redisproduct.product_price*redisproduct.cart_quantity}</td>
													...
													$.ajax({
														url : "ajaxisZeor.do?",
																...
																success : function(val) {
																	console.log("취소시 this의 바인드 변수 that값은");
																	console.log(that);
																	console.log("val->>"+val)
