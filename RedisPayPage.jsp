			...
			<div class="bodytitle">
				<div class="leftarea">
					...
					<div class="leftinfo">
						...
						<div class="contents">
							...
							<div class="col2">
								<h3>
									상품이름:<%=product_name%></h3>
								<h3 class="product_cods" value="<%=product_cod%>">
									상품코드:<%=product_cod%></h3>
									<!-- 수량 한정이므로 한개로 고정해버림 -->
								<h3 class="product_quantity" value="1">
									구매 수량:1</h3>							</div>
						</div>
					</div>
				...
				<div class="rightarea">
					<div class="rightinfo">
						...
						<button id="paytest">결제가 됬다는 가정하 테스트</button>
						
						<script>						
					$("#paytest").click(()=>{			
						
						
						let product_cod=<%=product_cod%>
						...
						let merchant_uid=Math.random().toString(36);						
						console.log("user_code:  "+user_code);										
						console.log("product_cod:  "+product_cod);	
						...
						/* 	console.log(cart_idarray) */
					 	 	 $.ajax({
								...
								success : function(data){				
									...
									console.log("결제 성공코드 1 이면 성공 -1 이면 에러로 자동 취소처리:  = "+data);
